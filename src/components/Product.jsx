            ...
            <div className="col-span-4 grid grid-cols-4 gap-4">
              {item.items.slice(0, 4).map(subItem => (
                <div key={subItem.uuid} className="bg-white border border-gray-200 rounded-lg shadow dark:bg-white">
                  ...
                  <h5 class="text-sm font-normal tracking-tight text-gray-800 dark:text-gray-800">{subItem.publication.title}</h5>
                  ...
                  <div className="px-4 py-3 flex">
                    ...
                    <span class="text-lg font-semibold text-gray-900 dark:text-gray-800">{subItem.publication.priceInfo.discountPrice}</span>
                  ...
                  <span class=" text-gray-700 text-xs font-semibold px-2.5 py-0.5 rounded  ms-3">{subItem.publication.rating}</span>
                  </div>
                </div>
              ))}
            </div>
